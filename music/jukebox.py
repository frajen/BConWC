...
try:
    from .mfvitools.insertmfvi import byte_insert
except ImportError:
    from mfvitools.insertmfvi import byte_insert
    
def add_music_player(rom, metadata, jukebox_title = "JOHNNY D.MAD JUKEBOX"):
