...
#use Lunar Expand to convert the WC seed to 48c Mbit ExHiROM (6 MB) ^3
#this causes problems with monster-expansion patch validation
#force 
#def write_patch(outfile, patchfilename, noverify=None, force=False):
def write_patch(outfile, patchfilename, noverify=True, force=False):
