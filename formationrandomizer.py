...
def get_formations(filename=None):
    ...
    for i in range(576):
        ...
        #print(str(f.formid) + " | " + str(f.pointer) + " | " + str(f.enemy_ids) +
              #" | " + str(f.enemies) + " | " + str(f.big_enemy_ids) + " | " +
              #str(f.mouldbyte) + " | " + str(f.enemies_present) + " | " +
              #str(f.misc1) + " | " + str(f.misc2) + " | " + str(f.misc3) + " | " +
              #str(f.mp) + " | " + str(f.eventscript))
        ...
        #convert enemies into enemyIDs
        enemiesList = []
        for m in f.enemies:
            if m != None:
                enemiesList.append(str.replace(m.name,"_",""))

        xyList = []
        for pos in f.enemy_pos:
            xpos, ypos = pos >> 4, pos & 0xF
            xyList.append([xpos, ypos])

        #print(str(f.formid) + " | " + str(f.pointer) + " | " + str(f.enemy_ids) +
              #" | " + str(enemiesList) + " | " + str(f.big_enemy_ids) + " | " +
              #str(xyList) + " | " + str(f.mouldbyte) + " | " + str(f.enemies_present) +
              #" | " + str(f.misc1) + " | " + str(f.misc2) + " | " + str(f.misc3) + " | " +
              #str(f.mp) + " | " + str(f.eventscript))
