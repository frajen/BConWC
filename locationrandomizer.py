...
###does uncommenting this out cause the location randomizer to break?
...
class Entrance():
    ...
    def write_data(self, fout, nextpointer):
        ...
        #asdf
        #we must convert something that can be read by write_multi

        #the following sets every entrance to be the same thing, proving you can directly
...
class EntranceSet():
    ...
    #write_data doesn't activate until
    #nextpointer, longnextpointer = e.write_data(fout, nextpointer, longnextpointer)
    #in randomizer.py
...
################
            #input("Hold")
            #print(e.dest) #= "0A9 Nikeah World of Balance"
            #print(e.destination) #= "0A9 Nikeah World of Balance"            
            #e.dest gives the hex value of the Location
            #convert this to decimal then use ZD to look up what it actually is
            #print(e.destx) # = "19"
            #print(e.desty) #= "31"
            #input("Hold")
...
################
            ...
            e.write_data(fout, nextpointer) #this is an Entrance.write_data
            nextpointer += 6
        for e in self.longentrances:
